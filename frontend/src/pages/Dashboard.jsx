...
// //     icon: Layers, 
// //     count: 2,
// //     img: "https://images.unsplash.com/photo-1610705001358-1bbd33192329?q=80&w=800&auto=format&fit=crop"
// //   },
// //   { 
// //     id: "elec", 
...
// //     <div className="min-h-screen bg-gradient-to-b from-[#0039A6] via-[#002875]/80 to-white relative p-6 pt-24 font-sans overflow-hidden flex flex-col items-center">
      
// //       {/* 1. LIFTED TITLE: Reduced margins (mt-4 mb-6) to pull everything up */}
...
// //       {/* 2. LIFTED CONTAINER: Reduced height from 600px to 480px so the bottom anchors higher up the screen */}
...
// //           // Variables to hold our 3D fan transformation data
// //           let translateX = 0;
// //           let translateY = 0;
// //           let rotateZ = 0;
// //           let scale = 1;
...
// //           // 3. UPDATED MATH: Reduced the translateY drops so the side cards don't dip below the screen
// //           if (diff === 0) {
// //             // CENTER (Active)
// //             zIndex = 50;
// //             scale = 1.05;
// //             translateY = -50; // Lifted higher
// //           } else if (diff === 1) {
// //             // RIGHT 1
// //             translateX = 180;
// //             translateY = 20; // Was 40
// //             rotateZ = 15;
// //             zIndex = 40;
// //             scale = 0.9;
// //           } else if (diff === -1) {
...
// //                 />
// //                 <div className="absolute inset-0 bg-gradient-to-b from-[#0039A6]/90 via-[#001f5c]/80 to-[#050B14] z-0" />

// //                 <div className="relative z-10 p-6 pt-8 text-center">
// //                   <h2 className="text-2xl font-extrabold text-white uppercase tracking-wider leading-tight drop-shadow-md">
// //                     {dept.name}
// //                   </h2>
// //                   <p className="text-blue-200 text-sm font-semibold tracking-widest uppercase mt-2">
// //                     {dept.count} Modules
// //                   </p>
// //                 </div>

// //                 <div className="relative z-10 p-6 flex flex-col items-center pb-8">
// //                   <div className={`w-20 h-20 rounded-full flex items-center justify-center shadow-xl transition-all duration-500 mb-6 ${
// //                     isActive ? "bg-white text-[#0039A6]" : "bg-[#0039A6]/50 text-white backdrop-blur-md border border-white/20"
// //                   }`}>
...
// //                 {/* UPDATED: Replaced the blue tint with a neutral black shadow gradient to preserve original colors while keeping text readable */}
...
// //                     {dept.name}
// //                   </h2>
// //                   {/* Changed text from blue-200 to white/90 for better contrast on natural images */}
// //                   <p className="text-white/90 text-sm font-semibold tracking-widest uppercase mt-2 drop-shadow-md">
// //                     {dept.count} Modules
// //                   </p>
// //                 </div>
...
// //                 <div className="relative z-10 p-6 flex flex-col items-center pb-8">
// //                   <div className={`w-20 h-20 rounded-full flex items-center justify-center shadow-xl transition-all duration-500 mb-6 ${
// //                     isActive ? "bg-white text-[#0039A6]" : "bg-white/20 text-white backdrop-blur-md border border-white/30"
// //                   }`}>
// //                     <dept.icon size={36} strokeWidth={isActive ? 2.5 : 2} />
// //                   </div>
...
const departments = [
  ...
  { 
    ...
    icon: Layers, 
    count: 2,
    img: "https://images.unsplash.com/photo-1620054768393-21cb0eb2f6c9?q=80&w=800&auto=format&fit=crop" 
  },
  { 
    id: "elec", 
    name: "Electrical Engineering", 
