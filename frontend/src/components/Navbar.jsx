...
// //               <Link 
// //                 to="/profile" 
// //                 className="text-slate-300 hover:text-white transition-all duration-300 transform hover:scale-110"
// //               >
...
//           {/* Conditional Rendering */}
//           {user ? (
//             // LOGGED IN: Show Profile Avatar & route to /profile
//             <div className="flex items-center pl-6 border-l border-white/20">
//               <Link 
//                 to="/profile" 
//                 className="transition-all duration-300 transform hover:scale-110 block"
//               >
//                 {/* Dynamically check if the user uploaded a profile picture */}
//                 {user.profilePic ? (
//                   <img 
//                     src={user.profilePic} 
//                     alt="Profile" 
//                     className="w-9 h-9 rounded-full object-cover border-2 border-white/20 hover:border-[#0039A6] transition-colors shadow-sm"
//                   />
//                 ) : (
//                   <UserCircle size={32} strokeWidth={1.5} className="text-slate-300 hover:text-white transition-colors" />
//                 )}
//               </Link>
//             </div>
//           ) : (
//             // NOT LOGGED IN: Show Login Button & route to /login
//             <div className="flex items-center pl-2">
//               <Link to="/login">
//                 <Button className="bg-[#0039A6] hover:bg-[#002875] text-white rounded-md px-6 py-2 text-sm font-medium transition-colors shadow-lg shadow-blue-900/20 border border-[#0039A6]/50">
//                   Login/Register
    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-slate-900/50 backdrop-blur-md border-b border-white/10 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          {/* Main Links (Visible to Everyone) */}
          <div className="hidden md:flex items-center gap-6">
          ...
          {user ? (
            // LOGGED IN: Show Profile Avatar & route to /profile
            <div className="flex items-center pl-6 border-l border-white/20">
              <Link to="/profile" className="transition-all duration-300 transform hover:scale-110 block">
                {/* Show DB image if exists, otherwise show default icon */}
                {user.profilePic ? (
                  <img 
                    src={user.profilePic} 
                    alt="Profile" 
