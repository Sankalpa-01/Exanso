...
export const AuthProvider = ({ children }) => {
  ...
  const fetchUserData = async (email, token) => {
    try {
      ...
      // RUTHLESS LOGOUT: If FastAPI rejects the token (401) OR if the server is down/restarting, 
      // strictly wipe the user session so the Navbar always goes back to "Login/Register"
